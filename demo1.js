...
var bala, balaD=false, nave,nave1,nave2;
...
function create() {
    ...
    nave1= juego.add.sprite(jugador.x -40, jugador.y - 400, 'nave1');
    nave2= juego.add.sprite(w -100, h-400 , 'nave2');
    ...
    //Mover izquierda
    MovIz = juego.input.keyboard.addKey(Phaser.keyboard.LEFT);
